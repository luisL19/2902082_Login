    ...
    public SecurityFilterChain securityFilterChain (HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(http -> {
                    ...
                    http.requestMatchers(HttpMethod.GET, "/auth/post").permitAll();
                    // Cofnigurar los endpoints privados
                    http.requestMatchers(HttpMethod.GET, "/auth/patch").hasAnyAuthority("READ");
...
//    }
    ...
    public UserDetailsService userDetailsService(){
      ...
      userDetailsList.add(User.withUsername("jordan")
        ...
        userDetailsList.add(User.withUsername("andrea")
                .password("1234")
                .roles("USER")
                .authorities("READ")
                .build());
